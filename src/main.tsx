...
//TODO чот не то с прохождением заказов. проверить создание, и прохождение по цепочке.
//TODO есть подозрение, что не отправляются сокет сообщения при взять/отдать заказ

//TODO флеш оповещения сделать {без стора ?? хз}
//TODO лампочка при отключении сокета
//TODO отфиксить появление описания на всех экранах
